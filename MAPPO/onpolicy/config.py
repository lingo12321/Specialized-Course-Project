...
def get_config():
    ...
    # Optional lightweight reward shaping for MPE Simple Spread.
    parser.add_argument("--use_duplicate_penalty", action="store_true", default=False,
                        help="penalize two or more agents occupying one landmark")
    parser.add_argument("--duplicate_penalty", type=float, default=0.1,
                        help="team penalty per extra nearby agent")
    parser.add_argument("--duplicate_threshold", type=float, default=0.1,
                        help="Agent-Landmark distance used to detect occupancy")
