...
def get_config():
    ...
    parser.add_argument("--episode_length", type=int,
                        default=3600, help="Max length for any episode")
    ...
    parser.add_argument("--data_chunk_length", type=int, default=2,
    ...
    # parser.add_argument("--model_dir", type=str,default='/home/data/cm/experiment/CoEMV_origin/onpolicy/scripts/results_sumo/SUMO/SUMO-best-finetune-mask-1-grid4x4/config3/grid4x4-flatten-ours-ippo_thr_1/ippo/seed_5_run1/models-2025-02-24-15-09',help="by default None. set the path to pretrained model.")
    ...
    ##### sumo
    parser.add_argument("--num_actions", type=int, default=8, help="")
    ##### sumo
    parser.add_argument("--hidden_layer_size", type=int, default=4, help="the hidden layer size of the body model.")
    # parser.add_argument("--episode_length", type=int, default=240, help="Max length for any episode")
    # parser.add_argument("--episode_length", type=int, default=4, help="Max length for any episode")
    parser.add_argument("--use_pressure", default=False, help="")
    parser.add_argument("--use_gat", default=False, help="")
    parser.add_argument("--use_ours", default=False, help="")
    parser.add_argument("--use_trans_critic", default=False, help="")
    parser.add_argument("--use_K", type=int, default=0, help="")
    parser.add_argument("--use_kl", default=False, help="whethre output score, then kl")
    parser.add_argument("--use_frap_in_trans", default=False, help="actor use : frap in trans")
    parser.add_argument("--use_3cons", default=False, help="whether using constraints")
    parser.add_argument("--use_sym_loss", default=True, help="whether using  symm constraints")
    parser.add_argument("--part_mask", default=True, help="whether using constraints part mask")

    parser.add_argument("--trans_hidden", type=int, default=64, help="trans hidden size")
    parser.add_argument("--use_trans_hidden", default=False, help="transformer using 112")
    parser.add_argument("--trans_heads", type=int, default=8, help="")
    parser.add_argument("--trans_layers", type=int, default=2, help="")

    parser.add_argument('--state_key', type=list,
                        default=['current_phase', 'car_num', 'queue_length', "occupancy", 'flow', 'stop_car_num',
                                 'pressure'])
    parser.add_argument("--port_start", type=int, default=-1, help="")
    parser.add_argument("--sumocfg_files", type=str, default="", help="")

    ##### v9
    parser.add_argument("--epsilon_decay", default=False, help="whether using episilon decay")
    parser.add_argument("--epsilon", type=float, default=1, help="")
    parser.add_argument("--min_epsilon", type=float, default=0.35, help="")
    parser.add_argument("--anneal_steps", type=int, default=500000, help="")  ### 50k 、、1000k == 1M

    parser.add_argument("--num_vehicle_agents", type=int, default=1472, help="")
    parser.add_argument("--num_emv_agents", type=int, default=24, help="")
    parser.add_argument("--num_ve_agents", type=int, default=1472, help="")
    parser.add_argument("--num_ve_actions", type=int, default=3, help="")
    return parser
